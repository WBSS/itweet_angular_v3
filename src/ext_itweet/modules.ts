...
angular.module("itweet.network", ['angular-cache', 'itweet.storage'])
    .service("itweetNetwork", itweet.model.ServiceFactory)
...
angular.module('itweet.overview', ['gettext', 'ui.router', 'ngMaterial'])
    .controller('OverviewController', itweet.overview.itweetOverviewController)
    .config(
